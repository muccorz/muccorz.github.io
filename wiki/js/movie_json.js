    ...
    $.ajax({
        ...
        success: function(data) {
            $.each(data, function(k, v) {
                ...
                $("ul").append("<li><div class='img'><img src='doubanimg/" + v.src + ".jpg'></div></li>")
                $("li:eq(" + k + ")").append(("<div class='box'></div>"));

                if (v.bool == '1') {

                    $("li:eq(" + k + ") .box").append(("<a target='_blank' href ='doubanimg/" + v.src + "/" + v.src + ".html' class='newpage' >" + v.title + "</a>"));
